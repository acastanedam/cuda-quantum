...
// ```
// nvq++ --target ibmq ibmq.cpp --ibmq-machine ibmq_kolkata -o out.x && ./out.x
// ```
...
// Define a simple quantum kernel to execute on IBMQ Server.
struct ghz {
